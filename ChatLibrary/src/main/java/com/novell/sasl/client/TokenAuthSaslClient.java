 ...
 */
public class TokenAuthSaslClient implements SaslClient {
	 ...
	 *                If a SaslClient instance cannot be created because of an
	 *                error
	 */
	public static SaslClient getClient(String authorizationId, String protocol,
		...
		return new TokenAuthSaslClient(authorizationId, protocol, serverName,
				props, cbh);
	}
	 ...
	 * 
	 */
	private TokenAuthSaslClient(String authorizationId, String protocol,
			String serverName, Map props, CallbackHandler cbh) {
