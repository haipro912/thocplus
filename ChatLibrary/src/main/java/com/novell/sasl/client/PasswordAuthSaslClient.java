 ...
 */
public class PasswordAuthSaslClient implements SaslClient {
	...
	public static SaslClient getClient(String authorizationId, String protocol,
		...
		return new PasswordAuthSaslClient(authorizationId, protocol,
	 ...
	 * 
	 */
	private PasswordAuthSaslClient(String authorizationId, String protocol,
			String serverName, Map props, CallbackHandler cbh) {
