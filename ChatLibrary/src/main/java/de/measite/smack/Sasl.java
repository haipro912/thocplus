...
public class Sasl {
	...
	public static Enumeration<SaslServerFactory> getSaslServerFactories() {
		return org.apache.harmony.javax.security.sasl.Sasl
	...
	public static SaslServer createSaslServer(String mechanism,
		...
		return org.apache.harmony.javax.security.sasl.Sasl.createSaslServer(
				mechanism, protocol, serverName, prop, cbh);
	}
...
//					System.out.println(mech[j] + " --- " + mechanisms[n]);
