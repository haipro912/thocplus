...
public class ChatManager {
     ...
     */
    private Map<String, Chat> threadChats = new ReferenceMap<String, Chat>(
            ReferenceMap.HARD, ReferenceMap.WEAK);

    /**
     * Maps jids to chats
     */
    private Map<String, Chat> jidChats = new ReferenceMap<String, Chat>(
            ReferenceMap.HARD, ReferenceMap.WEAK);
    ...
    ChatManager(Connection connection) {
        ...
        connection.addPacketListener(new PacketListener() {
            public void processPacket(Packet packet) {
                ...
                if (chat == null) {
                    chat = getUserChat(StringUtils.parseBareAddress(message
                            .getFrom()));
                }
                if (chat == null) {
     ...
     * @param listener the listener which will listen for new messages from this
     *                 chat.
    ...
    public void addChatListener(ChatManagerListener listener) {
        Log.i(TAG, "[VIETTEL] add ChatListener " + listener.hashCode());
    ...
    public void removeChatListener(ChatManagerListener listener) {
        Log.i(TAG, "[VIETTEL] remove ChatListener " + listener.hashCode());
