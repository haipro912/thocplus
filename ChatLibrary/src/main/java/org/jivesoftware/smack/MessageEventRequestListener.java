...
public interface MessageEventRequestListener {
     ...
     */
    void deliveredNotificationRequested(String from, String packetID,
     ...
     * @param messageEventManager the messageEventManager that fired the listener.
     */
    void displayedNotificationRequested(String from, String packetID,
                                        MessageEventManager messageEventManager);
     ...
     * @param messageEventManager the messageEventManager that fired the listener.
     */
    void composingNotificationRequested(String from, String packetID,
                                        MessageEventManager messageEventManager);
     ...
     * @param messageEventManager the messageEventManager that fired the listener.
     */
    void offlineNotificationRequested(String from, String packetID,
                                      MessageEventManager messageEventManager);
