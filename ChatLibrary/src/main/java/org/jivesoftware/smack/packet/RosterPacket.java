 ...
 * $RCSfile$
 * $Revision: 9548 $
 * $Date: 2007-12-03 01:00:03 +0100 (lun. 03 déc. 2007) $
 *
...
public class RosterPacket extends IQ {
    ...
    public static class Item {
        ...
        /**
         * set state of roster packet (online - offline - not used)
         *
         * @param state
         * @author DungNH8
         */
        ...
        public String toXML() {
            ...
            // DungNH8 add state(online, offline, not used) to item
            if (state >= 0) {
            ...
            if (lastChangeAvatar != null && lastChangeAvatar.length() > 0) {
                buf.append(" lastChangeAvatar=\"").append(lastChangeAvatar)
                        .append("\"");
            }
            buf.append(">");
