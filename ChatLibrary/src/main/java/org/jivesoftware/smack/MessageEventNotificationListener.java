...
public interface MessageEventNotificationListener {
     ...
     * @param packetID the id of the message that was sent.
     */
    void displayedNotification(String from, String packetID);
     ...
     * @param packetID the id of the message that was sent.
     */
    void composingNotification(String from, String packetID);
     ...
     * @param packetID the id of the message that was sent.
     */
    void offlineNotification(String from, String packetID);
     ...
     * @param packetID the id of the message that was sent.
     */
    void cancelledNotification(String from, String packetID);
}
