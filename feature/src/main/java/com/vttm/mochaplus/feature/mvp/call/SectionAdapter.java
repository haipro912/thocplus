...
public class SectionAdapter extends EasyRecyclerViewAdapter
    ...
    @Override public int[] getItemLayouts() {
        return new int[] { R.layout.item_contact_list};
    }
    ...
    @Override public void onBindRecycleViewHolder(EasyRecyclerViewHolder viewHolder, int position) {
        ...
        if (contacts.resId != 0) {
            ImageLoader.setImage(sectionIv.getContext(), contacts.resId, sectionIv);
        } else {
            ImageLoader.setImage(sectionIv.getContext(), R.drawable.img_default_head, sectionIv);
        }
