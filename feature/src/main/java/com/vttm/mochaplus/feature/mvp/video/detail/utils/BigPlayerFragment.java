...
package com.vttm.mochaplus.feature.mvp.video.detail.utils;
...
public class BigPlayerFragment extends BlackBoardDialogFragment {
    ...
    public interface Callback {
        ...
        void onBigPlayerDestroyed(int order, VideoModel baseItem, PlaybackInfo latestInfo);
    }
    ...
    public static BigPlayerFragment newInstance(int order, @NonNull VideoModel video,
                                                PlaybackInfo info) {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (windowManager == null || !ViewUtils.shouldUseBigPlayer(
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        playerView = view.findViewById(R.id.big_player);
        ...
        if (windowSize.y * (1.7777777778f) >= windowSize.x) {
    ...
    public void onStart() {
        ...
        if (playerHelper == null) {
            playerHelper = ToroExo.with(getContext()).getDefaultCreator().createPlayable(Uri.parse(videoItem.getOriginalPath()), null);
