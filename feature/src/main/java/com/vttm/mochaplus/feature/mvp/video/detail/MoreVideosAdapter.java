...
public class MoreVideosAdapter extends RecyclerView.Adapter<VideoDetailHolder> implements CacheManager {

    @NonNull
    private final VideoModel baseItem;
    private final long initTimeStamp;
    private final List<VideoModel> items = new ArrayList<>();
    ...
    public MoreVideosAdapter(@NonNull VideoModel baseItem, long initTimeStamp) {
        super();
