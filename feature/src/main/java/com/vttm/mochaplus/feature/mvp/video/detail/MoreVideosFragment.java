...
import com.vttm.mochaplus.feature.mvp.video.detail.utils.BigPlayerFragment;
...
public class MoreVideosFragment extends BaseFragment
    ...
    public interface Callback {
        ...
        void onPlaylistDestroyed(int basePosition, VideoModel baseItem, PlaybackInfo latestInfo);
    }

    public static final String TAG = "Toro:Fb:MoreVideos";

    // Arguments to start this fragment
    public static final String ARG_EXTRA_PLAYBACK_INFO = "fb:more_videos:playback_info";
    public static final String ARG_EXTRA_BASE_FB_VIDEO = "fb:more_videos:base_video";
    public static final String ARG_EXTRA_BASE_ORDER = "fb:more_videos:base_order";
    ...
    public static MoreVideosFragment newInstance(int position, @NonNull VideoModel video, @NonNull PlaybackInfo info) {
    ...
    public static MoreVideosFragment newInstance(Bundle bundle) {
        MoreVideosFragment fragment = new MoreVideosFragment();
        fragment.setArguments(bundle);
        return fragment;
    }

    private VideoModel baseVideo;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        layoutManager = new LinearLayoutManager(getContext()) {
            @Override
            public void smoothScrollToPosition(RecyclerView view, State state, int position) {
        ...
        adapter = new MoreVideosAdapter(baseVideo, System.currentTimeMillis());
    ...
    public void onViewStateRestored(@Nullable Bundle bundle) {
        ...
        if (ViewUtils.shouldUseBigPlayer(windowManager.getDefaultDisplay())) {
            ...
            VideoModel video = bundle.getParcelable(STATE_KEY_FB_VIDEO); // !can be null.
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        VideoModel item = adapter.getItem(firstPlayer.getPlayerOrder());
        if (item == null) {
    ...
    @Override
    public void onBigPlayerDestroyed(int videoOrder, VideoModel baseItem, PlaybackInfo latestInfo) {
